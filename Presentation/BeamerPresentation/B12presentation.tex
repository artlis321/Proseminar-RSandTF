...
\begin{frame}{Why we care about higher genus}
    \center{}
    \includegraphics[width=0.7\columnwidth]{example-image-b}
\end{frame}
...
\begin{frame}{Schottky group}{\tiny \cite{ComputationalSchottky} and \cite{Cha22}}
    \begin{block}{Schottky group}
        Choosing mutually disjoint discs $\{D_i,D_i'\}$ with interiors $\{\overset{\circ}{D}_i,\overset{\circ}{D}_i'\}$ on a Riemann sphere,
        ...
        \[\gamma_i(\bar C \setminus \overset{\circ}{D}_i) = D_i'\]
...
\begin{frame}{Differentials and Abel's map}{\tiny \cite{ComputationalSchottky} and \cite{Cha22}}
    ...
    And use these to define holomorphic differentials
